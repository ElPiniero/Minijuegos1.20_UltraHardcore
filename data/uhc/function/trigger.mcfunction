schedule function uhc:trigger 5t
function uhc:mobs/duplicacion

execute as @e[type=#uhc:zombi_humano,tag=!Zomboss] at @s run function uhc:mobs/zombies
execute as @e[type=zombie_villager] run attribute @s generic.movement_speed base set 0.4
execute as @e[type=#uhc:esqueletos,tag=!Huesudo] run function uhc:mobs/esqueletos
execute as @e[type=#uhc:aranas,tag=!Brincon] at @s run function uhc:mobs/aranas
execute as @e[type=creeper,tag=!Planta] at @s run function uhc:mobs/creeper
...
execute as @e[type=piglin,tag=!Cerdos] at @s run function uhc:mobs/piglins
execute as @e[type=piglin_brute,tag=!Cerdos] at @s run function uhc:mobs/piglins
execute as @e[type=blaze,tag=!Fuegazo] at @s run function uhc:mobs/blaze
execute as @e[type=magma_cube,tag=!CuboMagma] at @s run function uhc:mobs/cubo_de_magma
execute as @e[type=hoglin,tag=!Cerdotote] at @s run function uhc:mobs/hoglin

execute as @e[type=interaction,tag=Cerebro_Tumba] run tag @s add toco_suelo
execute as @e[type=interaction,tag=Cerebro_Tumba] at @s on vehicle on passengers run tag @s remove toco_suelo
execute as @e[type=interaction,tag=Cerebro_Tumba,tag=toco_suelo] at @s if block ~ ~-1 ~ air run summon snowball ~ ~ ~
execute as @e[type=interaction,tag=Cerebro_Tumba,tag=toco_suelo] at @s if block ~ ~-1 ~ air run tag @s remove toco_suelo
execute as @e[type=interaction,tag=Cerebro_Tumba,tag=!toco_suelo] at @s run ride @s mount @n[type=snowball]
